...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    department: 'Produit',
    description: 'Nous recherchons un chef de produit expérimenté.',
    status: 'Actif',
    candidateCount: 25,
    hardSkills: ['Product Management', 'Agile', 'Scrum'],
    softSkills: ['Communication', 'Stratégie'],
  ...
  },
  {
    ...
    department: 'Design',
    description: 'Nous recherchons un designer UI/UX créatif.',
    status: 'En pause',
    candidateCount: 12,
    hardSkills: ['Figma', 'Adobe XD', 'Prototyping'],
    softSkills: ['Créativité', 'Empathie'],
  ...
  },
  {
    ...
    department: 'Ingénierie',
    description: 'Nous recherchons un développeur backend Node.js.',
    status: 'Fermé',
    candidateCount: 32,
    hardSkills: ['Node.js', 'Express', 'MongoDB'],
    softSkills: ['Résolution de problèmes', 'Collaboration'],
